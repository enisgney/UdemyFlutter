...
void main(){
  ...
  // Listelerde sıralama yaparken Comparator sınıfından yararlanılır.
  // Aşağıdaki kod ile öğrenci nolar arasında küçükten büyüğe sıralama yapılır.
  ...
  // Aşağıdaki kod ile öğrenci nolar arasında büyükten küçüğe sıralama yapılır.
  ...
  // Aşağıdaki kod ile öğrenci adları arasında küçükten büyüğe sıralama yapılır.
...
// Aşağıdaki kod ile öğrenci adları arasında büyükten küçüğe sıralama yapılır.
